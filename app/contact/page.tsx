          ...
          <div className="rounded-2xl bg-white border border-slate-200 p-6 md:p-7 shadow-sm">
            ...
            <form onSubmit={onSubmit} className="mt-6 space-y-4 text-sm">
              ...
              <input
                ...
                className="w-full rounded-md border border-slate-300 px-3 py-2 bg-slate-50 focus:ring-2 focus:ring-sky-700"
              />
              ...
              <button
                ...
                className="w-full rounded-md bg-sky-700 px-5 py-3 text-sm font-semibold text-white hover:bg-sky-800 transition"
              >
